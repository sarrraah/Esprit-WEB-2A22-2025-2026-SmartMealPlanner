...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (
        ...
        $error = 'Date of birth must be in YYYY-MM-DD format and must be a valid date.';
...
<div class="page-shell">
    ...
    <div class="topbar">
        <div>
            <h1>Add User</h1>
            <p>Create a new account and add it directly to the platform.</p>
        </div>
        ...
        <form method="POST" action="">
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    >
                    <span class="hint">Allowed format: YYYY-MM-DD</span>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        type="password"
                        name="mot_de_passe"
                        value="<?= htmlspecialchars($_POST['mot_de_passe'] ?? '') ?>"
                ...
                <div class="form-group">
                    ...
                    <select id="role" class="form-control" name="role">
                        ...
                        <option value="coach" <?= (($_POST['role'] ?? '') === 'coach') ? 'selected' : '' ?>>Coach</option>
                        <option value="nutritionist" <?= (($_POST['role'] ?? '') === 'nutritionist') ? 'selected' : '' ?>>Nutritionist</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="statut" class="form-control" name="statut">
                        ...
                        <option value="active" <?= (($_POST['statut'] ?? '') === 'active') ? 'selected' : '' ?>>Active</option>
                        <option value="banned" <?= (($_POST['statut'] ?? '') === 'banned') ? 'selected' : '' ?>>Banned</option>
                    </select>
                </div>
            </div>
